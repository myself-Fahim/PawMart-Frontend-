        ...
        <>
            ...
            <div style={{
                ...
                <form onSubmit={handleEmailPass} >
                    <h1 className='text-center text-white titan text-3xl font-bold mb-7'>Login Here!</h1>
                    <fieldset className="fieldset shadow-2xl py-8 border-base-300 rounded-box w-xs border p-4">
                        ...
                        <button className="btn btn-neutral bg-cyan-900 border-none  hover:transition ease-in-out mt-4 ">Login</button>
                        ...
                        <p className='mt-[10px] text-center text-white'>Don't have an account? <Link to='/register' className='underline font-bold text-white'>Register here</Link>
                        </p>
                    </fieldset>
